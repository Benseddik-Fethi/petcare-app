...
import {Calendar, Dog, Home, LogOut, PawPrint, Settings} from "lucide-react";
...
export default function DashboardLayout() {
    ...
    return (
        <div
            className="min-h-screen bg-gradient-to-br from-rose-50 via-pink-50 to-amber-50 dark:from-slate-950 dark:via-slate-900 dark:to-slate-950 flex">
            {/* SIDEBAR */}
            <div
                className="w-72 bg-white/70 dark:bg-slate-900/70 backdrop-blur-xl border-r border-rose-100 dark:border-slate-800 p-6 flex flex-col fixed h-full z-20">
                <div className="flex items-center gap-3 mb-10">
                    <div
                        className="w-12 h-12 bg-gradient-to-br from-rose-400 to-pink-400 rounded-2xl flex items-center justify-center shadow-lg shadow-rose-200 dark:shadow-none">
            ...
            PetCare
                ...
                <div className="pt-6 border-t border-rose-100 dark:border-slate-800">
                    <div
                        className="flex items-center gap-3 p-3 rounded-2xl hover:bg-rose-50 dark:hover:bg-slate-800 transition-colors cursor-pointer group">
                        <div
                            className="w-10 h-10 bg-gradient-to-br from-amber-300 to-rose-300 dark:from-slate-700 dark:to-slate-600 rounded-xl flex items-center justify-center text-white font-semibold">

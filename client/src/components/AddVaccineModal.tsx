...
import {Calendar as CalendarIcon, FileSignature, Loader2, Plus, Syringe} from "lucide-react";
        ...
        <Dialog open={open} onOpenChange={setOpen}>
            <DialogTrigger asChild>
                <Button variant="outline"
                        className="border-rose-200 text-rose-600 hover:bg-rose-50 hover:border-rose-300 dark:border-rose-800 dark:text-rose-400 dark:hover:bg-rose-900/20 rounded-xl shadow-sm transition-all">
            ...
            <DialogContent
                ...
                {/* Header */}
                <div
                    className="bg-gradient-to-r from-rose-50 to-purple-50 dark:from-rose-950/30 dark:to-purple-950/30 p-6 pb-8">
                    <DialogHeader>
                        <DialogTitle className="flex flex-col items-center gap-3 text-center">
                            <div
                                className="w-14 h-14 bg-white dark:bg-slate-800 rounded-2xl flex items-center justify-center shadow-sm text-rose-500">
                                <Syringe size={28}/>
                            </div>
                            <div className="space-y-1">
                                <h2 className="text-xl font-bold text-gray-800 dark:text-white">Nouveau vaccin</h2>
                                <p className="text-sm text-gray-500 dark:text-gray-400 font-normal">Enregistrez un
                                    rappel ou une injection</p>
                            </div>
                        </DialogTitle>
                    </DialogHeader>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-6 pt-2 space-y-5">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2 flex flex-col">
                            <Label className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Fait
                                le</Label>
                            <Popover>
                        ...
                        <div className="space-y-2 flex flex-col">
                            <Label
                                className="text-xs font-bold text-gray-400 uppercase tracking-wider ml-1">Rappel</Label>
                            <Popover>
                                <PopoverTrigger asChild>
                                    <Button
                                        variant={"outline"}
                    ...
                    <Button type="submit"
                            className="w-full h-12 bg-gradient-to-r from-rose-400 to-purple-500 hover:from-rose-500 hover:to-purple-600 text-white rounded-xl font-bold shadow-lg shadow-rose-100 dark:shadow-none mt-2"
                            disabled={loading}>
